...
class ContrastRamp {
  ...
  static const List<int> values = [
    step0, step50, step100, step200, step300, step400, 
    step500, step600, step700, step800, step900, step1000
  ];
}
...
class SpacingTokens {
  ...
  static const List<double> values = [
    ...
    space20, space24, space28, space32, space40
  ];
}
...
class RadiusTokens {
  ...
  static const List<double> values = [
    radius2, radius4, radius8, radius12, radius16, radius20, radiusFull
  ];
}
